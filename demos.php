      ...
      <div class="container"> 
        ...
        <div class="explain">
          ...
          <div class="row-fluid"> 
            <div class="span4">
              <h3>Online Chat</h3>
              <p>Perhaps the first thing anyone tries when attempting realtime applications is chat. It is the quintessential realtime application.</p>
              <p>We show you a simple example of how you could create a realtime chat application for your project.</p>
              <p><a href='/chat' class='btn btn-success'>View demo</a></p>
            </div>

            <div class="span4">
              <h3>Analytics</h3>
              <p>Collect information on your users as they move around your site and display them in a fancy-pants realtime reporting suite.</p>
